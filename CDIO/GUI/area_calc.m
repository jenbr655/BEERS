function [area_mole]=area_calc(Image) %% Area ber�kning 
...
tot_area=bwarea(Image); %total area in pixels 

num_one=sum(Image(:)==1); %how many ones i matrix

[x_val y_val]=size(Image); %size of picture
